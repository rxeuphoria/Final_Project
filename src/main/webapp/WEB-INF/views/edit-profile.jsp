...
<center><img src="macgro.png" height="100" width="100"/></center>
	...
	<form action="/edit-submit" >
			<label>Gender:<a href="" data-toggle="tooltip"
				title="Do you currently have hormone levels more akin to a male or female?  We ask this to prevent overfeeding/starving when calculating allowances.">(?)</a></label> <select name="gender" >
			...
			<label>Start Date:<a href="#" data-toggle="tooltip" title="New interval starts here.  We recommend a week, but it should be tailored to what you can manage and use to prevent any spoiled food.">(?)</a></label>
