...
<form action="/logout"> <button type="submit" class="button button4" style="float: right">Logout</button></form>
	...
	<div class="container">
		...
		<form action="/calculations">
			<label>Gender:<a href="" data-toggle="tooltip"
				title="Do you currently have hormone levels more akin to a male or female?  We ask this to prevent overfeeding/starving when calculating allowances.">(?)
			...
			<br> <label>Height:</label> <input type="number" name="height"
				...
				name="age" /><br> <br> <label>Activity Level:<a href=""
				data-toggle="tooltip"
				title="The dirty secret here is that you're not as active as you think you are.  If you're unsure, select an activity level 1 lower than you feel could be correct.  You can always change it later if you start to exercise more or less!">(?)
					</a></label> <select name="activity">
			...
			<br> <label>Weekly Goal:<a href="" data-toggle="tooltip" title="The typical interval we recommend is 7 days, so these are what we calculate to weight gain/loss per week.">(?)</a></label> <select name="change">
			...
			<br> <label>Start Date:<a href="" data-toggle="tooltip" title="The easiest starting interval to manage is roughly a week in length.  If you start to become an expert planner, you can always add to the duration!  We've got you covered if you want build a list and shop in bulk.">(?)</a></label> <input type="date"
